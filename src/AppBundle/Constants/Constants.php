...
class Constants
{
    ...
    public static $temporaryUploadFolder =  "temp-files" . DIRECTORY_SEPARATOR. "temp-uploads" . DIRECTORY_SEPARATOR; // fileName
    public static $temporaryOutputFolder =  "temp-files" . DIRECTORY_SEPARATOR. "temp-outputs" . DIRECTORY_SEPARATOR; // fileName
    ...
    public static $maxUploadSize = 6291456;
    ...
    public static $mailer = "sender@zatvarachki.com";
